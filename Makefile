...
# Backward-compatible aliases (older CI/scripts may still use these names)
.PHONY: fw_haltewunsch_mini_pi_v0 fw_haltewunsch_mini_pi_v1
.PHONY: haltewunsch_mini_pi_v0_flash haltewunsch_mini_pi_v1_flash
.PHONY: haltewunsch_mini_pi_v0_flash_only haltewunsch_mini_pi_v1_flash_only
fw_haltewunsch_mini_pi_v0: fw_mini_pi
fw_haltewunsch_mini_pi_v1: hmpi_v1
haltewunsch_mini_pi_v0_flash: mini_pi_flash
haltewunsch_mini_pi_v1_flash: hmpi_v1_flash
haltewunsch_mini_pi_v0_flash_only: mini_pi_flash_only
haltewunsch_mini_pi_v1_flash_only: hmpi_v1_flash_only

# Generic clean alias expected by some build scripts
.PHONY: clean
clean: all_fw_clean all_ut_clean
